        ...
        <div className="min-h-screen bg-brand-cream">
          ...
          <main>
            <Routes>
              ...
              <Route
                path="/our-story"
                element={<Lazy Component={OurStory} />}
              />
              <Route
                path="/collection"
                element={<Lazy Component={Collection} />}
              />
              <Route
                path="/product/:slug"
                element={<Lazy Component={ProductDetail} />}
              />
              <Route
                path="/journal"
                element={<Lazy Component={JournalPage} />}
              />
              <Route
                path="/journal/:slug"
                element={<Lazy Component={JournalPost} />}
              />

              {/* Guest order lookup */}
              <Route
                path="/track"
                element={<Lazy Component={OrderTracking} />}
              />

              {/* Customer account (gated) */}
              <Route
                path="/account"
                element={<Gated Component={AccountHome} />}
              />
              <Route
                path="/account/profile"
                element={<Gated Component={Profile} />}
              />
              <Route
                path="/account/orders"
                element={<Gated Component={Orders} />}
              />
              <Route
                path="/account/orders/:id"
                element={<Gated Component={OrderDetail} />}
              />
              <Route
                path="/account/addresses"
                element={<Gated Component={Addresses} />}
              />
              <Route
                path="/account/wishlist"
                element={<Gated Component={Wishlist} />}
              />

              {/* Legal & policy */}
              <Route
                path="/privacy"
                element={<Lazy Component={PrivacyPolicy} />}
              />
              <Route
                path="/terms"
                element={<Lazy Component={TermsOfService} />}
              />
              <Route
                path="/shipping"
                element={<Lazy Component={ShippingPolicy} />}
              />
              <Route
                path="/returns"
                element={<Lazy Component={ReturnsPolicy} />}
              />

              {/* Fallback */}
              {/* Fallback — real 404 (noindex), not a redirect to home */}
